...
> 本文将以极空间的图形界面的形式进行介绍，如果你更喜欢命令形式，你可以点击左侧导航栏的命令示例
...
在docker服务中，选择镜像，点击仓库，选择自定义拉取，输入`ghcr.io/eventhorizonsky/anilinkserver:latest`

![image-20260321173200626](/quick-start-jkj/image-20260321173200626.jpg)
...
![image-20260321173504983](/quick-start-jkj/image-20260321173504983.jpg)
...
![image-20260321173651689](/quick-start-jkj/image-20260321173651689.jpg)

修改端口为你目前没有别的程序占用的端口，右侧的容器的8081**不要改**，然后点击应用即可。

![image-20260321173749918](/quick-start-jkj/image-20260321173749918.jpg)

说明：

- `/data` 用于持久化 H2 数据库文件，以及一些缓存或临时文件（字幕、临时下载目录等）
